...
def verify(directory):
    ...
    with tempfile.TemporaryDirectory(prefix="proofml-dist-") as temp:
        ...
        run("-c", "from proofml import audit, AuditPolicy; r = audit('tiny.csv', target='y', unavailable_features=('post_event',)); assert AuditPolicy(severity='critical', require_checks=('feature_availability',)).enforce(r).passed")
